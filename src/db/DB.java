...
public class DB {
	...
	public static Connection getConnection() {
		if(conn == null) { //Verificar se a variável de controle é nula
			try {
				...
				String url = props.getProperty("dburl"); //Acessando e atribuindo a url do banco de dados no arquivo à uma variável
	...
	private static Properties loadProperties() { //Metodo do tipo "Propriedade" do java
		try(FileInputStream fs = new FileInputStream("db.properties")){ //Leitura direta do arquivo na raiz do projeto, lendo uma sequência de dados
